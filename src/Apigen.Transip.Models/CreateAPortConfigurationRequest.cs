...
/// <summary>
/// CreateAPortConfigurationRequest from OpenAPI schema.
/// Schema path: #/components/schemas/CreateAPortConfigurationRequest
/// </summary>
public class CreateAPortConfigurationRequest
{
  /// <summary>
