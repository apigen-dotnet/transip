...
/// <summary>
/// InstallAnOperatingSystemOnAVpsRequest from OpenAPI schema.
/// Schema path: #/components/schemas/InstallAnOperatingSystemOnAVpsRequest
/// </summary>
public class InstallAnOperatingSystemOnAVpsRequest
{
  /// <summary>
