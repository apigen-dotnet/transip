...
public partial interface IOpenStackClient
{
  ...
  /// </summary>
  Task CancelProjectAsync(string projectId, CancellationToken cancellationToken = default);

  /// <summary>
  /// List a single project
  /// Operation: GET /openstack/projects/{projectId}
  /// </summary>
  Task<JsonElement> ListSingleProjectAsync(string projectId, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task UpdateProjectAsync(string projectId, Apigen.TransIp.Models.UpdateProjectRequest updateProjectRequest, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task RemoveUserProjectAsync(string projectId, string userId, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<JsonElement> ListUserAsync(string userId, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task UpdateUserAsync(string userId, Apigen.TransIp.Models.UpdateUserRequest updateUserRequest, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task DeleteS3TokenAsync(string userId, string tokenId, Apigen.TransIp.Models.DeleteS3TokenRequest deleteS3TokenRequest, CancellationToken cancellationToken = default);

  /// <summary>
  /// List a S3 token
  /// Operation: GET /openstack/users/{userId}/tokens/{tokenId}
  /// </summary>
  Task<JsonElement> ListS3TokenAsync(string userId, string tokenId, CancellationToken cancellationToken = default);
