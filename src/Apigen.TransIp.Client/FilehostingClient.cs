...
/// </summary>
public partial class FilehostingClient : IFilehostingClient
{
  ...
  /// </summary>
  public async Task CancelDiskAsync(string diskId, Apigen.TransIp.Models.CancelDiskRequest cancelDiskRequest, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<JsonElement> GetDiskDiskIdAsync(string diskId, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["diskId"] = diskId
  ...
  /// </summary>
  public async Task UpdateDiskAsync(string diskId, Apigen.TransIp.Models.UpdateDiskRequest updateDiskRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["diskId"] = diskId
  ...
  /// </summary>
  public async Task RevertBackupDiskAsync(string diskId, string backupId, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["diskId"] = diskId,
  ...
  /// </summary>
  public async Task DetachCustomDomainDiskAsync(string diskId, string customDomainId, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["diskId"] = diskId,
