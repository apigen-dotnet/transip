...
public partial class FilehostingClient
{
  ...
  internal FilehostingClient(HttpClient httpClient, ILogger? logger = null)
  {
  ...
  /// </summary>
  public async Task<JsonElement> ListAllDisksAsync(CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task OrderNewDiskAsync(Apigen.TransIp.Models.OrderNewDiskRequest orderNewDiskRequest, CancellationToken cancellationToken = default)
  {
    string url = "filehosting/disks";
  ...
  /// </summary>
  public async Task DeleteAsync(string diskId, Apigen.TransIp.Models.CancelDiskRequest cancelDiskRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["diskId"] = diskId
    };
    string url = "filehosting/disks/{diskId}".BuildUrl(pathParams);
  ...
  /// </summary>
  public async Task<JsonElement> GetAsync(string diskId, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["diskId"] = diskId
  ...
  /// </summary>
  public async Task UpdateAsync(string diskId, Apigen.TransIp.Models.UpdateDiskRequest updateDiskRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["diskId"] = diskId
    ...
    try
    {
      ...
      string json = JsonSerializer.Serialize(updateDiskRequest, JsonConfig.Default);
  ...
  /// </summary>
  public async Task<JsonElement> ListAllBackupsDiskAsync(string diskId, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["diskId"] = diskId
    };
    string url = "filehosting/disks/{diskId}/backups".BuildUrl(pathParams);
  ...
  /// </summary>
  public async Task UpdateAsync(string diskId, string backupId, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["diskId"] = diskId,
    ...
    string url = "filehosting/disks/{diskId}/backups/{backupId}".BuildUrl(pathParams);
  ...
  /// </summary>
  public async Task<JsonElement> ListAllCustomDomainNamesDiskAsync(string diskId, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["diskId"] = diskId
    };
    string url = "filehosting/disks/{diskId}/custom-domains".BuildUrl(pathParams);
  ...
  /// </summary>
  public async Task AttachCustomDomainNameDiskAsync(string diskId, Apigen.TransIp.Models.AttachCustomDomainNameDiskRequest attachCustomDomainNameDiskRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["diskId"] = diskId
  ...
  /// </summary>
  public async Task DeleteAsync(string diskId, string customDomainId, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["diskId"] = diskId,
    ...
    string url = "filehosting/disks/{diskId}/custom-domains/{customDomainId}".BuildUrl(pathParams);
  ...
  /// </summary>
  public async Task UpgradeDiskContractAsync(string diskId, Apigen.TransIp.Models.UpgradeDiskContractRequest upgradeDiskContractRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["diskId"] = diskId
    };
    string url = "filehosting/disks/{diskId}/upgrades".BuildUrl(pathParams);
  ...
  /// </summary>
  public async Task<JsonElement> ListAllUsersDiskAsync(string diskId, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["diskId"] = diskId
    };
    string url = "filehosting/disks/{diskId}/users".BuildUrl(pathParams);
  ...
  /// </summary>
  public async Task ResetPasswordDiskUserAsync(string diskId, Apigen.TransIp.Models.ResetPasswordDiskUserRequest resetPasswordDiskUserRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["diskId"] = diskId
