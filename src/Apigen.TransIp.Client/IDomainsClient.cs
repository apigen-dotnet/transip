...
public partial interface IDomainsClient
{
  ...
  /// </summary>
  Task<JsonElement> CheckAvailabilityDomainNameAsync(string domainName, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<JsonElement> ListAsync(Apigen.TransIp.Models.ListAllDomainsRequest listAllDomainsRequest, CancellationToken cancellationToken = default);

  /// <summary>
  /// Transfer a domain
  /// Operation: POST /domains
  /// </summary>
  Task CreateAsync(Apigen.TransIp.Models.TransferDomainRequest transferDomainRequest, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task HandoverAsync(string domainName, Apigen.TransIp.Models.HandoverDomainRequest handoverDomainRequest, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<JsonElement> ListAllContactsAsync(string domainName, CancellationToken cancellationToken = default);

  /// <summary>
  /// Update contacts for a domain
  /// Operation: PUT /domains/{domainName}/contacts
  /// </summary>
  Task UpdateContactsAsync(string domainName, Apigen.TransIp.Models.UpdateContactsDomainRequest updateContactsDomainRequest, CancellationToken cancellationToken = default);

  /// <summary>
  /// Remove a DNS entry from a domain
  /// Operation: DELETE /domains/{domainName}/dns
  /// </summary>
  Task RemoveDnsEntryAsync(string domainName, Apigen.TransIp.Models.RemoveDnsEntryDomainRequest removeDnsEntryDomainRequest, CancellationToken cancellationToken = default);

  /// <summary>
  /// List all DNS entries for a domain
  /// Operation: GET /domains/{domainName}/dns
  /// </summary>
  Task<JsonElement> ListAllDnsEntriesAsync(string domainName, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task AddNewSingleDnsEntryAsync(string domainName, Apigen.TransIp.Models.AddNewSingleDnsEntryDomainRequest addNewSingleDnsEntryDomainRequest, CancellationToken cancellationToken = default);

  /// <summary>
  /// Update all DNS entries for a domain
  /// Operation: PUT /domains/{domainName}/dns
  /// </summary>
  Task UpdateAllDnsEntriesAsync(string domainName, Apigen.TransIp.Models.UpdateAllDnsEntriesDomainRequest updateAllDnsEntriesDomainRequest, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<JsonElement> ListNameserversAsync(string domainName, CancellationToken cancellationToken = default);

  /// <summary>
  /// Update nameservers for a domain
  /// Operation: PUT /domains/{domainName}/nameservers
  /// </summary>
  Task UpdateNameserversAsync(string domainName, Apigen.TransIp.Models.UpdateNameserversDomainRequest updateNameserversDomainRequest, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<JsonElement> GetSslCertificateIdAsync(string domainName, decimal certificateId, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<JsonElement> GetInfoTldAsync(string tld, CancellationToken cancellationToken = default);
