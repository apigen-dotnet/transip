...
public partial class AcronisClient
{
  ...
  /// </summary>
  public async Task<JsonElement> ListAllTenantsAsync(CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task OrderNewTenantAsync(Apigen.TransIp.Models.OrderNewTenantRequest orderNewTenantRequest, CancellationToken cancellationToken = default)
  {
    string url = "acronis/tenants";
  ...
  /// </summary>
  public async Task DeleteAsync(string tenantUuid, Apigen.TransIp.Models.CancelTenantRequest cancelTenantRequest, CancellationToken cancellationToken = default)
  {
    ...
    try
    {
      ...
      string json = JsonSerializer.Serialize(cancelTenantRequest, JsonConfig.Default);
  ...
  /// </summary>
  public async Task<JsonElement> GetAsync(string tenantUuid, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["tenantUuid"] = tenantUuid
  ...
  /// </summary>
  public async Task UpdateAsync(string tenantUuid, Apigen.TransIp.Models.UpdateTenantRequest updateTenantRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["tenantUuid"] = tenantUuid
  ...
  /// </summary>
  public async Task OrderAddonsAsync(string tenantUuid, Apigen.TransIp.Models.OrderAddonsRequest orderAddonsRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["tenantUuid"] = tenantUuid
  ...
  /// </summary>
  public async Task DeleteAsync(string tenantUuid, string addonName, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["tenantUuid"] = tenantUuid,
  ...
  /// </summary>
  public async Task DowngradeTenantAsync(string tenantUuid, Apigen.TransIp.Models.DowngradeTenantRequest downgradeTenantRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["tenantUuid"] = tenantUuid
  ...
  /// </summary>
  public async Task<JsonElement> GenerateOneTimeTokenLoginUrlAsync(string tenantUuid, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["tenantUuid"] = tenantUuid
  ...
  /// </summary>
  public async Task UpgradeTenantAsync(string tenantUuid, Apigen.TransIp.Models.UpgradeTenantRequest upgradeTenantRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["tenantUuid"] = tenantUuid
  ...
  /// </summary>
  public async Task<JsonElement> FetchOverviewCurrentStorageUsageDeprecatedAsync(string tenantUuid, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["tenantUuid"] = tenantUuid
  ...
  /// </summary>
  public async Task<JsonElement> FetchOverviewCurrentUsagesAsync(string tenantUuid, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["tenantUuid"] = tenantUuid
