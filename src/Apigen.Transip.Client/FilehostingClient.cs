...
public class FilehostingClient
{
  ...
  /// </summary>
  public async Task<JsonElement> ListAllDisksAsync()
  {
  ...
  /// </summary>
  public async Task<JsonElement> GetAsync(string diskId)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["diskId"] = diskId
  ...
  /// </summary>
  public async Task UpdateAsync(string diskId, Apigen.Transip.Models.UpdateDiskRequest updateDiskRequest)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["diskId"] = diskId
  ...
  /// </summary>
  public async Task UpdateAsync(string diskId, string backupId)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["diskId"] = diskId,
  ...
  /// </summary>
  public async Task DeleteAsync(string diskId, string customDomainId)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["diskId"] = diskId,
