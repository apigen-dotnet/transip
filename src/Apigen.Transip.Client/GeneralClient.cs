...
public partial class GeneralClient
{
  ...
  /// </summary>
  public async Task<JsonElement> ApiTestAsync()
  {
    string url = "api-test";
  ...
  /// </summary>
  public async Task<JsonElement> ListAvailableAvailabilityZonesAsync()
  {
  ...
  /// </summary>
  public async Task<JsonElement> ListAllProductsAsync()
  {
    string url = "products";
